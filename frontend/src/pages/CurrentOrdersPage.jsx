      ...
      <div style={styles.container}>
        <div style={styles.headerRow}>
          <div>
            ...
            <h1 style={styles.title}>Current Orders</h1>
            <p style={styles.subtitle}>
              These are your paid orders that are still waiting to be dispatched by the seller.
            </p>
          </div>
        ...
        {orders.length === 0 ? (
          <div style={styles.emptyCard}>
            <h3 style={styles.emptyTitle}>No current orders</h3>
            <p style={styles.emptyText}>
              Once you complete payment, orders waiting for seller dispatch will appear here.
            </p>
          </div>
        ) : (
                ...
                <div style={styles.itemsBox}>
                  {order.items.map((item) => (
                    <div key={item.itemId} style={styles.itemCard}>
                      ...
                      <div style={styles.waitingBadge}>Awaiting Dispatch</div>
                    </div>
                  ))}
                </div>
              </div>
