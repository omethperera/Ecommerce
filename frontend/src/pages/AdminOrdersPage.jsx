        ...
        <div style={styles.headerRow}>
          <div>
            ...
            <p style={styles.subtitle}>
              View paid orders for your products and mark pending ones as dispatched.
            </p>
          </div>
                    ...
                    <div key={item.itemId} style={styles.itemCard}>
                      ...
                      <div style={styles.itemActions}>
                        {order.orderStatus === "PENDING_DISPATCH" ? (
                          ...
                          <div style={styles.doneBadge}>Dispatched</div>
                        )}
                      </div>
                    </div>
                  ))}
